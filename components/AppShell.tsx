...
import { BarChart3, ClipboardList, Factory, FileSearch, LogOut, Users, Warehouse } from "lucide-react";
      ...
      <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4">
          ...
          <nav className="flex items-center gap-2 overflow-x-auto">
            ...
            <Link className="touch-target inline-flex items-center gap-2 rounded-md px-4 py-3 text-lg font-bold text-ink hover:bg-slate-100" href="/yard">
              <Warehouse size={24} /> Yard
            </Link>
